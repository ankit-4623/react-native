  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.text_container}>
        <Text style={styles.text_in_log}>Hey,</Text>
        <Text style={styles.text_in_log}>Welcome</Text>
        <Text style={styles.text_in_log}>Back</Text>
      </View>
      ...
      <View>
        ...
        <TouchableOpacity style={styles.log_in_btu_wrap}>
          <Text style={styles.log_in_btu}>Login</Text>
        </TouchableOpacity>
      ...
      <View style={styles.sign_con}>
        <Text style={styles.acco}>Don't Hava any accout </Text>
        <Text style={styles.sign_up } onPress={sign_up}>Sign Up</Text>
      </View>
    </View>
  );
};
